# Generated by Django 3.2.4 on 2021-07-27 13:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_quizzes', to='accounts.instructorprofile')),
            ],
            options={
